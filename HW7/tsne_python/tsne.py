...
def drawSimilarities(p, q, labels,mode,perplexity):
    ...
    plt.show()
    plt.savefig(f"./tsne_python/{mode}_{perplexity}_Similarities.png")


def sne(labels, X=np.array([]), no_dims=2, initial_dims=50, perplexity=30.0, mode = "t-sne"):
    """
    ...
    drawSimilarities(P, Q, labels,mode,perplexity)
    # Return solution
    return Y,gif_pic
